package com.igueyetraining.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.igueyetraining.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.igueyetraining.security.DomainUserDetailsService", "createSpringSecurityUser");
